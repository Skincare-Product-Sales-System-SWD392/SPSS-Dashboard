...
import {getAllCategories, addCategory, updateCategory, deleteCategory} from "slices/category/thunk";
...
const Category = () => {
  ...
  const categorySelector = createSelector(
    ...
    (category) => ({
      ...
      firstRowOnPage: category?.categories?.firstRowOnPage || 0,
      rowCount: category?.categories?.rowCount || 0,
  ...
  useEffect(() => {
    ...
    dispatch(getAllCategories({ page: currentPage, pageSize }));
  ...
  const handleDelete = () => {
    if (eventData) {
      dispatch(deleteCategory(eventData.id))
        .then(() => {
          ...
          {data && data.length > 0 ? (
            <TableContainer
              ...
              onPageChange={(page: number) => {
                setCurrentPage(page);
                dispatch(getAllCategories({ page, pageSize }));
              }}
            ...
            <div className="noresult">
              <div className="py-6 text-center">
                ...
                <p className="mb-0 text-slate-500 dark:text-zink-200">
                  We've searched more than 199+ categories We did not find any
                  categories for you search.
                </p>
              </div>
            </div>
          )}
      ...
      >
        ...
        >
          <Modal.Title className="text-16">
            {isOverview ? "Category Details" : isEdit ? "Edit Category" : "Add Category"}
          </Modal.Title>
        </Modal.Header>
