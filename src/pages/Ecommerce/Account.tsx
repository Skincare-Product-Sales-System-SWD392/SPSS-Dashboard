...
const Account = () => {
    ...
    return (
        <React.Fragment>
                        ...
                        <div className="card-body">
                            <div className="flex items-center">
                                ...
                                <div className="shrink-0">
                                    <button type="button" className="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20" onClick={toggle}><Plus className="inline-block size-4" /> <span className="align-middle">Update Account</span></button>
                                </div>
                            </div>
                        </div>
                            ...
                            {user && user.length > 0 ?
                                ...
                                (<div className="noresult">
                                    <div className="py-6 text-center">
                                        ...
                                        <h5 className="mt-2 mb-1">No Account Information Found</h5>
                                        <p className="mb-0 text-slate-500 dark:text-zink-200">Please add your account details to manage your profile.</p>
                                    </div>
                                </div>)}
                        </div>
                    </div>
            ...
            {/* User Modal */}
            <Modal show={show} onHide={toggle} id="accountModal" modal-center="true"
                ...
                <Modal.Header className="flex items-center justify-between p-4 border-b dark:border-zink-300/20"
                    ...
                    <Modal.Title className="text-16">{!!isEdit ? "Update Account" : "Add Account"}</Modal.Title>
                </Modal.Header>
