...
// Icon
import { MoreHorizontal, Eye, FileEdit, Trash2, Search, Plus, Download, Upload, ChevronLeft, ChevronRight } from 'lucide-react';
        ...
        const templateData = [
            {
                ...
                productType: "Single",
                gender: "Unisex",
                skinTypes: "3fa85f64-5717-4562-b3fc-2c963f66afa6,4fa85f64-5717-4562-b3fc-2c963f66afa7", // Comma-separated IDs
                ...
                imageUrls: "https://example.com/image1.jpg,https://example.com/image2.jpg" // Comma-separated URLs
            }
        ];
        ...
        <React.Fragment>
                    ...
                    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 xl:grid-cols-12">
                        ...
                        <div className="xl:col-span-9">
                            <div className="flex flex-wrap items-center gap-2 justify-end">
                                ...
                                {/* Add Product Button */}
                                <Link to="/products-add-new" className="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">
                                    ...
                                    <thead className="ltr:text-left rtl:text-right bg-white dark:bg-zink-700">
                                        <tr>
                                            {columns.map((column: any, index: number) => (
                                                <th key={index} className="px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500">
                                                    {column.header}
                                                </th>
                                            ))}
                                        </tr>
                                        ...
                                        {data.map((item: any, index: number) => (
                                            <tr key={index}>
                                                {columns.map((column: any, cellIndex: number) => (
                                                    <td key={cellIndex} className="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                                        {column.cell ? column.cell({ row: { original: item }, getValue: () => item[column.accessorKey] }) : item[column.accessorKey]}
                                                    </td>
                                                ))}
                                            </tr>
                                        ))}
            ...
            >
                ...
                <Modal.Body className="p-4">
                    ...
                    <div className="mt-4">
                        <label className="inline-block mb-2 text-base font-medium">Select File</label>
                        <input
                            type="file"
                    ...
                    <div className="mt-4">
                        <p className="text-sm text-slate-500 dark:text-zink-200">
                            <span className="font-medium">Note:</span> Make sure your Excel file follows the template format. 
                            <button 
                                type="button" 
